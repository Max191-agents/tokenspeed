...
`DSATopKSlotInputValues`, `MLAKVPackQuantizeFP8InputValues`, and
`MLAPrefillFP8InputValues`, plus DeepSeek V4 sparse-prefill index helpers that
accept the tensors and scalar workspace parameters generated by
