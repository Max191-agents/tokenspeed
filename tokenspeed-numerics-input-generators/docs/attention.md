...
DSA sparse slot conversion, and MLA K/V pack+quantize helpers that map directly
to `GDNQKVSplitInputValues`, `PackedQKVComplexRotaryInputValues`,
...
through small adapters. The generator values are operation-level values. Tests
