...
square of its hidden dimension and applies learned weights; fused variants add
Q/K splitting, rotary embedding, gates, residuals, or parallel reductions.

## Generators

- `RMSNormInputs`: generates input and weight tensors for RMSNorm.
